"""FileOrganizer dialogs — Editor dialogs (Categories, Templates, Rules, File Browser)."""
import os, re
...
class PCCategoryEditorDialog(QDialog):
    ...
    def _on_cat_select(self, row):
        ...
        default_hint = FileOrganizer._default_pc_dst_static(c['name'])
...
class _FileBrowserDialog(QDialog):
    ...
    def _populate(self, folder_path: str):
        from fileorganizer.naming import _beautify_name
