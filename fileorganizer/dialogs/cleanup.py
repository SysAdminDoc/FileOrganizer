"""FileOrganizer dialogs — Cleanup tools (scanner worker, dialog, and panel)."""
import os
...
class CleanupToolsDialog(QDialog):
    ...
    def _start_scan(self):
        from fileorganizer.cleanup import (
    ...
    def _on_item_found(self, item):
        ...
        from fileorganizer.cleanup import _fmt_size
    ...
    def _delete_selected(self):
        ...
        from fileorganizer.cleanup import delete_items, _fmt_size
