...
from fileorganizer.categories import get_all_categories, get_all_category_names, CATEGORIES
...
def _build_llm_system_prompt() -> str:
    ...
    from fileorganizer.profiles import get_llm_system_prompt_prefix, get_profile_categories
