"""Scan logic mixin for FileOrganizer main window."""
...
from fileorganizer.config import _LAST_CONFIG_FILE
from fileorganizer.cache import compute_file_fingerprint
from fileorganizer.categories import is_generic_aep
from fileorganizer.naming import _beautify_name, _smart_name, _extract_name_hints
from fileorganizer.classifier import _SCAN_FILTERS
from fileorganizer.bootstrap import HAS_MAGIC, HAS_RAPIDFUZZ
from fileorganizer.metadata import MetadataExtractor
from fileorganizer.engine import RenameTemplateEngine
from fileorganizer.photos import load_photo_settings, _PHOTO_FOLDER_PRESETS
...
class ScanMixin:
    """Mixin containing all scan-related methods for FileOrganizer."""
