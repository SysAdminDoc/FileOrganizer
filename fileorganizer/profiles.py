"""FileOrganizer — Scan Profiles: switchable behavior sets for different organizing scenarios."""
import os, json
...
def get_profile_categories(profile_name: str = None) -> list:
    ...
    from fileorganizer.categories import CATEGORIES, get_all_categories
