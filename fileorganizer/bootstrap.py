"""FileOrganizer — Dependency bootstrap and optional imports."""

#!/usr/bin/env python3
"""FileOrganizer v7.5.0 - Context-Aware Classification + Smart Naming + Photo Library + Face Recognition + HEIC/WEBP Auto-Convert + File Type Filter"""
