"""FileOrganizer — PC file classification, scan cache, MIME detection, filename intelligence."""
import os, re, json, sqlite3, time
import mimetypes as _mimetypes
from pathlib import Path
from datetime import datetime

from fileorganizer.bootstrap import HAS_PILLOW, HAS_MAGIC, HAS_RAPIDFUZZ
try:
...
from fileorganizer.config import _APP_DATA_DIR, _PC_SCAN_CACHE_DB
