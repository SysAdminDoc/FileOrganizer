        ...
        [
            new AppTheme("steam-dark", "Steam Dark",
                ...
                new()
                {
                    ...
                    ["BrandSurfaceDangerHover"] = C("#351313"),
                    ["BrandSurfaceDangerPressed"] = C("#4a1818"),
                    ...
                    ["BrandTextMuted"] = C("#8492a6"),
                    ["BrandTextSubtle"] = C("#8492a6"),
                    ["BrandTextDanger"] = C("#ff8a8a"),
            ...
            new AppTheme("catppuccin-mocha", "Catppuccin Mocha",
                ...
                new()
                {
                    ...
                    ["BrandSurfaceDangerHover"] = C("#4a2832"),
                    ["BrandSurfaceDangerPressed"] = C("#5b303c"),
                    ...
                    ["BrandTextMuted"] = C("#b0b8d4"),
                    ["BrandTextSubtle"] = C("#b0b8d4"),
                    ["BrandTextDanger"] = C("#ffb0c8"),
            ...
            new AppTheme("oled-black", "OLED Black",
                ...
                new()
                {
                    ...
                    ["BrandSurfaceDangerHover"] = C("#300a12"),
                    ["BrandSurfaceDangerPressed"] = C("#470f1c"),
                    ...
                    ["BrandTextMuted"] = C("#888888"),
                    ["BrandTextSubtle"] = C("#888888"),
                    ["BrandTextDanger"] = C("#ff6688"),
            ...
            new AppTheme("github-dark", "GitHub Dark",
                ...
                new()
                {
                    ...
                    ["BrandSurfaceDangerHover"] = C("#40131d"),
                    ["BrandSurfaceDangerPressed"] = C("#571925"),
                    ...
                    ["BrandTextSubtle"] = C("#8b949e"),
                    ["BrandTextDanger"] = C("#ff7b72"),
            ...
            new AppTheme("nord", "Nord",
                ...
                new()
                {
                    ...
                    ["BrandSurfaceDangerHover"] = C("#4b3038"),
                    ["BrandSurfaceDangerPressed"] = C("#5b3740"),
                    ...
                    ["BrandTextSubtle"] = C("#c0c5cf"),
                    ["BrandTextDanger"] = C("#f5b0b6"),
            ...
            new AppTheme("dracula", "Dracula",
                ...
                new()
                {
                    ...
                    ["BrandSurfaceDanger"] = C("#3a1f25"),
                    ["BrandSurfaceDangerHover"] = C("#4a2830"),
                    ["BrandSurfaceDangerPressed"] = C("#5a3038"),
                    ...
                    ["BrandTextMuted"] = C("#c6c6cb"),
                    ["BrandTextSubtle"] = C("#c6c6cb"),
                    ["BrandTextDanger"] = C("#ffb0b0"),
            ...
            new AppTheme("light", "Light",
                ...
                new()
                {
                    ...
                    ["BrandSurfaceDangerHover"] = C("#f7cad3"),
                    ["BrandSurfaceDangerPressed"] = C("#f3bac5"),
                    ...
                    ["BrandTextMuted"] = C("#5d6670"),
                    ["BrandTextSubtle"] = C("#5d6670"),
                    ["BrandTextDanger"] = C("#a40e26"),
